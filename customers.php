        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><button onclick="location.href = './detail.php?id= <?php echo $rows['id']; ?>';" type="button" class="btn btn-primary">View Customer</button></td>
                </tr>
                <?php
                    }
                ?>
